...
if (isset($_POST['proses'])) {
    ...
    if ($cek > 0) {
        ...
        echo '<script>alert("Login Sukses");window.location="cekMember.php"</script>';
    } else {
        echo '<script>alert("Maaf! data yang anda masukan salah.");history.go(-1);</script>';
    }
}
if (isset($_SESSION['status'])) {
    header('location: cekMember.php');
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <form method="POST">
                            ...
                            <button class="btn btn-purple form-control-user btn-block" name="proses" type="submit">Login</button>
                        </form>
                    </div>
                </div>
            </div>
