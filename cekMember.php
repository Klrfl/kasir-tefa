        ...
        <div class="card-body py-4">
          ...
          <form method="POST">
            ...
            <div class="form-group row mb-0">
              ...
              <input type="hidden" name="tgl_input" class="form-control" value="<?php echo  date("j F Y, G:i"); ?>" readonly>
          ...
          if (isset($_POST['save'])) {
            ...
            if (empty($d['statusMember'])) {
              ...
              $sql = "INSERT INTO keranjangstatus ( nomor_telpon, nama, statusMember,tgl_input) VALUES('$nomor_telpon','$nama','$statusMember', '$tgl_input')";
