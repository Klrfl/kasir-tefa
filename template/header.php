  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-purple text-white shadow-sm sticky-top d-md-none d-lg-none d-xl-none">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link putih" href="member.php"><i class="fa fa-shopping-bag mr-2"></i>Member</a>
        </li>
        <li class="nav-item">
      ...
      <div class="col-md-3 mb-2 d-none d-md-block">
        <div class="card">
          ...
          <div class="card-body">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="cekMember.php"><i class="fa fa-user text-purple mr-2"></i>Cek Member</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="member.php"><i class="fa fa-user text-purple mr-2"></i>Set Member</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="laporan.php"><i class="fa fa-table text-purple mr-2"></i>Laporan Penjualan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="laporanMember.php"><i class="fa fa-table text-purple mr-2"></i>Laporan Member</a>
              </li>
              <li class="nav-item">
